...
- Goto this site in **TARGET DOMAIN** : `type ur target --> scroll down look for OSINT & RECON --> click on subdomains.`
![[Subdomain_Enumeration_using_dorking.png]]

### **4. Using Search in Censys.io : [here](https://platform.censys.io/search)**
...
```shell
/usr/share/wordlists/assetnote/best-dns-wordlist.txt  # ← BEST
```
### **📁 LARGE** (Deep scan ~100k+)
...
> **Use `best-dns-wordlist.txt` for most scans.**
