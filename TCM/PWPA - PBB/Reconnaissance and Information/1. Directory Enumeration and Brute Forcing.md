...
- **Arachni**: Full web scanner with common/backup file checks.
    ...
    - Specific checks: `--checks=common_files,backup_files`.[](https://github.com/CrypterENC/My-Obi-Notes/blob/main/TCM/TCM%20CERTS/PWPA/PWPA%20-%20PBB/4.%20Recon%20and%20Information%20Gathering/4.%20Recon%20and%20Information%20Gathering.md)​
        
- **Nikto**: Web server scanner that also finds dangerous/interesting files.
    
    - Basic: `nikto -h http://target.com`
        
    - SSL: `-h https://target.com -ssl`.[](https://github.com/CrypterENC/My-Obi-Notes/blob/main/TCM/TCM%20CERTS/PWPA/PWPA%20-%20PBB/4.%20Recon%20and%20Information%20Gathering/4.%20Recon%20and%20Information%20Gathering.md)​
