...
5.  **Defects in Multistage Login Mechanism or MFA :**
	-  **Insecure implementation of the MFA Function.**
		-  ![[Defects_in_MFA.png]]
6.  **Insecure Storage of Credentials :** 
	-  **Uses plain text, encrypted, or weekly hashed password data stored in Backend.**
		- ![[Insecure_storage_of_credentials.png]]
...
### **Best Wordlist for Authentication Brute Force :**

#### **PASSWORDS :** PATH : `ls /usr/share/seclists/Passwords/Common-Credentials/`

```shell
1. /usr/share/seclists/Passwords/Common-Credentials/10-million-password-list-top-100.txt
2. /usr/share/seclists/Passwords/Common-Credentials/10-million-password-list-top-1000.txt  
...
```shell
1. /usr/share/seclists/Usernames/top-usernames-shortlist.txt
2. /usr/share/seclists/Usernames/xato-net-10-million-usernames.txt
```
